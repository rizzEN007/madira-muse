...
export default function SupplierForm({ initial, onSave, onClose }) {
    ...
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: '10px', padding: '2rem', width: '420px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
          <h2 style={{ margin: 0, fontSize: '18px' }}>{initial ? 'Edit Supplier' : 'Add Supplier'}</h2>
        ...
        <form onSubmit={submit}>
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input name="name" value={form.name} onChange={handle} style={inputStyle} placeholder="Supplier name" />
          </div>
          <div style={{ marginBottom: '1rem' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#555' }}>Address</label>
            <input name="address" value={form.address} onChange={handle} style={inputStyle} placeholder="Supplier address" />
          </div>
          <div style={{ marginBottom: '1rem' }}>
